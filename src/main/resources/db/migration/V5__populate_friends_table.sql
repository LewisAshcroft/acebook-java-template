...
CREATE TABLE users (
                       ...
                       relationship_status varchar(50) CHECK (relationship_status IN ('Single', 'In a Relationship', 'It''s Complicated', 'Engaged', 'Married', 'In a Civil Union', 'In a Domestic Partnership', 'In an Open Relationship', 'Separated', 'Divorced', 'Widowed')),
...
-- Seed users:
INSERT INTO users (auth0_id, username, email, first_name, middle_name, last_name, birthday, profile_picture, banner_picture, bio, location, workplace, relationship_status, is_public, created_at, updated_at, enabled)
VALUES
    ('auth0|A1B2C3D4E5F6', 'john_doe', 'john.doe@example.com', 'John', 'Michael', 'Doe', '1990-02-15', 'https://example.com/profile1.jpg', 'https://example.com/banner1.jpg', 'Loves technology and software development.', 'New York, USA', 'TechCorp', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|G7H8I9J0K1L2', 'jane_smith', 'jane.smith@example.com', 'Jane', 'Marie', 'Smith', '1985-06-25', 'https://example.com/profile2.jpg', 'https://example.com/banner2.jpg', 'Passionate about graphic design and art.', 'Los Angeles, USA', 'DesignWorks', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|M3N4O5P6Q7R8', 'alex_lee', 'alex.lee@example.com', 'Alex', 'Jaden', 'Lee', '1992-03-10', 'https://example.com/profile3.jpg', 'https://example.com/banner3.jpg', 'Coffee enthusiast and software engineer.', 'San Francisco, USA', 'CodeX Solutions', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|S9T0U1V2W3X4', 'chris_jones', 'chris.jones@example.com', 'Chris', 'David', 'Jones', '1988-11-05', 'https://example.com/profile4.jpg', 'https://example.com/banner4.jpg', 'Travel lover, writer, and photographer.', 'Chicago, USA', 'Wanderlust Media', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|Z5A6B7C8D9E0', 'samantha_brown', 'samantha.brown@example.com', 'Samantha', 'Grace', 'Brown', '1995-09-12', 'https://example.com/profile5.jpg', 'https://example.com/banner5.jpg', 'Marketing professional and yoga instructor.', 'Austin, USA', 'MarketUp', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|K1L2M3N4O5P6', 'michael_johnson', 'michael.johnson@example.com', 'Michael', 'William', 'Johnson', '1987-12-30', 'https://example.com/profile6.jpg', 'https://example.com/banner6.jpg', 'Outdoor enthusiast and web developer.', 'Seattle, USA', 'WebWorks', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|Q7R8S9T0U1V2', 'linda_davis', 'linda.davis@example.com', 'Linda', 'Ann', 'Davis', '1991-05-22', 'https://example.com/profile7.jpg', 'https://example.com/banner7.jpg', 'Health and wellness advocate.', 'Miami, USA', 'FitLife', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|Y1Z2A3B4C5D6', 'robert_miller', 'robert.miller@example.com', 'Robert', 'Andrew', 'Miller', '1983-07-17', 'https://example.com/profile8.jpg', 'https://example.com/banner8.jpg', 'Guitarist and software architect.', 'Boston, USA', 'TechDev', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|J4K5L6M7N8O9', 'emily_wilson', 'emily.wilson@example.com', 'Emily', 'Rose', 'Wilson', '1994-01-03', 'https://example.com/profile9.jpg', 'https://example.com/banner9.jpg', 'Digital marketer and photography enthusiast.', 'Denver, USA', 'AdVantage', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|B2C3D4E5F6G7', 'david_moore', 'david.moore@example.com', 'David', 'James', 'Moore', '1989-08-19', 'https://example.com/profile10.jpg', 'https://example.com/banner10.jpg', 'Tech lover, gamer, and entrepreneur.', 'Dallas, USA', 'GameTech', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|F2G3H4I5J6K7', 'nina_patel', 'nina.patel@example.com', 'Nina', 'Priya', 'Patel', '1992-04-17', 'https://example.com/profile11.jpg', 'https://example.com/banner11.jpg', 'Food lover and social entrepreneur.', 'Mumbai, India', 'Savor Co.', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|M2N3O4P5Q6R7', 'omar_khan', 'omar.khan@example.com', 'Omar', 'Ali', 'Khan', '1987-09-23', 'https://example.com/profile12.jpg', 'https://example.com/banner12.jpg', 'Engineer and advocate for renewable energy.', 'Karachi, Pakistan', 'GreenFuture', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|W3X4Y5Z6A7B8', 'ana_santos', 'ana.santos@example.com', 'Ana', 'Luiza', 'Santos', '1990-11-30', 'https://example.com/profile13.jpg', 'https://example.com/banner13.jpg', 'Passionate about digital marketing and nature.', 'São Paulo, Brazil', 'EcoPlus', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|E8F9G1H2I3J4', 'yuki_ando', 'yuki.ando@example.com', 'Yuki', 'Satoshi', 'Ando', '1989-12-10', 'https://example.com/profile14.jpg', 'https://example.com/banner14.jpg', 'Tech enthusiast and game developer.', 'Tokyo, Japan', 'NexTech', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|L1M2N3O4P5Q6', 'mohamed_ali', 'mohamed.ali@example.com', 'Mohamed', 'Abdullah', 'Ali', '1994-06-02', 'https://example.com/profile15.jpg', 'https://example.com/banner15.jpg', 'Student of AI and software development.', 'Cairo, Egypt', 'TechVision', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|A9B8C7D6E5F4', 'joseph_williams', 'joseph.williams@example.com', 'Joseph', 'Lucas', 'Williams', '1987-01-14', 'https://example.com/profile16.jpg', 'https://example.com/banner16.jpg', 'Entrepreneur and sports enthusiast.', 'San Diego, USA', 'InnoVentures', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|P3Q4R5S6T7U8', 'olivia_taylor', 'olivia.taylor@example.com', 'Olivia', 'Grace', 'Taylor', '1993-07-11', NULL, NULL, 'Graphic designer and cat lover.', 'Portland, USA', 'CreativeSpark', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|V5W6X7Y8Z9A0', 'kevin_rodgers', 'kevin.rodgers@example.com', 'Kevin', 'James', 'Rodgers', '1990-10-03', NULL, NULL, 'Photographer and web developer.', 'Atlanta, USA', 'SnapTech', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|D8E9F1G2H3I4', 'chloe_martin', 'chloe.martin@example.com', 'Chloe', 'Elaine', 'Martin', '1988-08-21', NULL, NULL, 'Artist and art educator.', 'Austin, USA', 'ArtLife', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|J2K3L4M5N6O7', 'jackson_harris', 'jackson.harris@example.com', 'Jackson', 'Scott', 'Harris', '1992-05-17', NULL, NULL, 'Tech writer and gaming enthusiast.', 'Boston, USA', 'GameZone', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|I4J5K6L7M8N9', 'ella_davis', 'ella.davis@example.com', 'Ella', 'Sophia', 'Davis', '1994-02-22', NULL, NULL, 'Fashion blogger and photographer.', 'Los Angeles, USA', 'StyleHouse', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|B3C4D5E6F7G8', 'benjamin_clark', 'benjamin.clark@example.com', 'Benjamin', 'Elliot', 'Clark', '1986-03-01', NULL, NULL, 'Data scientist and tech innovator.', 'Chicago, USA', 'TechWorld', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|N6O7P8Q9R1S2', 'maria_garcia', 'maria.garcia@example.com', 'Maria', 'Elena', 'Garcia', '1990-09-15', NULL, NULL, 'Social media strategist and yoga lover.', 'Miami, USA', 'SocialWorks', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|T8U9V1W2X3Y4', 'ethan_white', 'ethan.white@example.com', 'Ethan', 'Cole', 'White', '1991-12-04', NULL, NULL, 'Tech enthusiast and guitarist.', 'Denver, USA', 'CodeLab', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|R3S4T5U6V7W8', 'isabella_lee', 'isabella.lee@example.com', 'Isabella', 'Jade', 'Lee', '1989-04-12', NULL, NULL, 'Healthcare professional and writer.', 'San Francisco, USA', 'HealthFirst', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|F7G8H9I1J2K3', 'jason_perez', 'jason.perez@example.com', 'Jason', 'Gabriel', 'Perez', '1992-11-28', NULL, NULL, 'Software engineer and gaming enthusiast.', 'New York, USA', 'TechInc', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|L6M7N8O9P1Q2', 'sophie_morris', 'sophie.morris@example.com', 'Sophie', 'Louise', 'Morris', '1990-08-05', NULL, NULL, 'Digital artist and illustrator.', 'Chicago, USA', 'CreativeCo', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|B5C6D7E8F9G0', 'james_wright', 'james.wright@example.com', 'James', 'William', 'Wright', '1993-01-19', NULL, NULL, 'Web designer and coffee lover.', 'Los Angeles, USA', 'WebStudio', NULL, TRUE, NOW(), NOW(), TRUE),
    ('auth0|J3K5L6M7N0O9', 'lucas_king', 'lucas.king@example.com', 'Lucas', 'Samuel', 'King', '1986-06-27', NULL, NULL, 'Mechanical engineer and tech innovator.', 'Miami, USA', 'TechWorks', NULL, TRUE, NOW(), NOW(), TRUE);
